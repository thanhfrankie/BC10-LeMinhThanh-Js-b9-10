...
var nv = layThongTinTuForm()
  ...
  if (gioLam >= 192) {
    document.getElementById.innerHTML = ` Nhân viên xuất sắc`;
  } else if (gioLam >= 176) {
    document.getElementById.innerHTML = ` Nhân viên giỏi`;
  } else if (gioLam >= 160) {
    document.getElementById.innerHTML = ` Nhân viên khá`;
  } else {
    document.getElementById.innerHTML = ` Nhân viên trung bình`;
  }
